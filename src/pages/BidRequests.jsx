...
job_title}
  ...
  { bid?.deadline&& format(new Date(bid?.deadline),'P')}
                  </td>
...
category
                  ...
                  <td className='px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap'>
                    <div className='inline-flex  items-center px-3 py-1 rounded-full gap-x-2 bg-yellow-100/60 text-yellow-500'>
                      ...
                      <h2 className={`text-sm font-normal ${bid.status==="complete" && "text-green-500"}`}>{bid.status}</h2>
                    </div>
                  </td>
                  <td className='px-4 py-4 text-sm whitespace-nowrap'>
                    <div className='flex items-center gap-x-6'>
                      ...
                      <button
                       ...
                       onClick={()=>handleStatus(bid._id,bid.status,"in Progress")}  className={`disabled:cursor-not-allowed  text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none`}>
                        <svg
